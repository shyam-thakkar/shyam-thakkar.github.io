...
const experiences: Job[] = [
  {
    ...
    logo: <Image src="https://weserve.codes/assets/images/Weserve_logo-white.svg" alt="WeServeCodes Pvt Ltd." width={60} height={20} className="object-contain h-5 w-auto" />,
    description: [
  ...
  },
  {
    ...
    logo: <Image src="/Picture1.png" alt="CrossShores Infotech" width={60} height={20} className="object-contain h-5 w-auto" />,
    description: [
  ...
  },
  {
    ...
    logo: <Briefcase className="w-5 h-5 text-orange-600" />,
    description: [
      ...
      <div className="relative border-l-2 border-zinc-200 dark:border-zinc-800 ml-3 md:ml-6 space-y-12">
        {experiences.map((job, index) => (
          <div key={index} className="relative pl-8 md:pl-12">
            {/* Dot */}
            <div className="absolute -left-[9px] top-6 w-4 h-4 rounded-full bg-white dark:bg-zinc-950 border-4 border-zinc-400 dark:border-zinc-600" />
            ...
            <ul className="space-y-3">
              {job.description.map((item, i) => (
                <li key={i} className="text-zinc-600 dark:text-zinc-400 leading-relaxed flex items-start gap-2">
